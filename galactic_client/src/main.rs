...
fn main() {
    ...
    let mut gameplay_list : Vec<GamePlayPacket> = Vec::new();
    ...
    loop{
        ...
        for pack in recv_packets.iter() {
            {
                ...
                match packet.packet_type {
                    ...
                    PacketType::GAMEPLAY => {
                        if let Data::game_play { packet } = packet.packet_data {
                            gameplay_list.push(packet)
                        }
                    }, 
        ...
        println!(
            ...
            gameplay_list.last(), player_spawn_list.last(),
            disconnect_list.last()
        );
        break;
    }
}